...
--==============================================================
local ADMIN_BUILD = "2026-06-09-silver-panel"
...
function TagDB:mergeLocal()
    ...
    -- Local edits win over the remote pastebin. The tag editor saves into
    -- localEntries, so on rejoin those overrides must replace whatever the
    -- pastebin has for the same key — otherwise saves silently disappear
    -- whenever the user reloads the script.
    local n = 0
