...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Use at your own risk." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Seigeloadstring" },
      { property: "og:description", content: "Use at your own risk." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Seigeloadstring" },
      { name: "twitter:description", content: "Use at your own risk." },
